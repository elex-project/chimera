...
@Slf4j
@ToString
public final class DeviceResetResultResponse extends BaseResponse {
	public static final int STATUS_OK = 200;
	public static final int STATUS_UNREGISTERED_ExecInstance = 404;

	private ExecInstance execInstance;

	DeviceResetResultResponse(@NotNull HttpResponse<String> response) {
		super(response);
		if (null != xml) {
			try {
